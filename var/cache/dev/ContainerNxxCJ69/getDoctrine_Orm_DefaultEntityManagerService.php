...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\AreaRepository' => function () {
    return ($this->privates['App\Repository\AreaRepository'] ?? $this->load(__DIR__.'/getAreaRepositoryService.php'));
}, 'App\\Repository\\MonthRepository' => function () {
    return ($this->privates['App\Repository\MonthRepository'] ?? $this->load(__DIR__.'/getMonthRepositoryService.php'));
...
}, 'App\\Repository\\SistemRepository' => function () {
...
}, 'App\\Repository\\YearRepository' => function () {
    return ($this->privates['App\Repository\YearRepository'] ?? $this->load(__DIR__.'/getYearRepositoryService.php'));
}))));
