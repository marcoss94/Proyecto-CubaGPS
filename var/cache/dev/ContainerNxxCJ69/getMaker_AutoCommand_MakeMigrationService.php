...
$this->privates['maker.auto_command.make_migration'] = $instance = new \Symfony\Bundle\MakerBundle\Command\MakerCommand(new \Symfony\Bundle\MakerBundle\Maker\MakeMigration($this->targetDirs[3]), ($this->privates['maker.file_manager'] ?? $this->load(__DIR__.'/getMaker_FileManagerService.php')), ($this->privates['maker.generator'] ?? $this->load(__DIR__.'/getMaker_GeneratorService.php')));
