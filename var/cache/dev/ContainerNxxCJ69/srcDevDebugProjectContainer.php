...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->fileMap = array(
            ...
            'App\\Controller\\AreaController' => __DIR__.'/getAreaControllerService.php',
            'App\\Controller\\BlogController' => __DIR__.'/getBlogController2Service.php',
            'App\\Controller\\DateController' => __DIR__.'/getDateControllerService.php',
            'App\\Controller\\ReportController' => __DIR__.'/getReportControllerService.php',
    ...
    protected function getTwigService()
    {
        ...
        $g->setDisplayOptions(array('fileLinkFormat' => $e));
        ...
        $n->setDisplayOptions(array('maxStringLength' => 4096, 'fileLinkFormat' => $e));

        $o = new \Symfony\Bridge\Twig\AppVariable();
        $o->setEnvironment('dev');
        $o->setDebug(true);
        if ($this->has('security.token_storage')) {
            $o->setTokenStorage(($this->services['security.token_storage'] ?? $this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()));
        }
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\DumpExtension(($this->services['var_dumper.cloner'] ?? $this->getVarDumper_ClonerService()), $g));
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'KnpSnappyBundle' => array(
                    'path' => 'E:/xamp/htdocs/zxccxz/vendor/knplabs/knp-snappy-bundle',
