...
// Returns the private 'App\Repository\SistemRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SistemRepository.php';

return $this->privates['App\Repository\SistemRepository'] = new \App\Repository\SistemRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
