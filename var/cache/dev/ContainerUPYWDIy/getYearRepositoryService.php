...
// Returns the private 'App\Repository\YearRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\YearRepository.php';

return $this->privates['App\Repository\YearRepository'] = new \App\Repository\YearRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
